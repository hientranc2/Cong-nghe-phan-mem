export const contentByLanguage = {
  vi: {
    ...
    menuLabels: {
      ...
      addToCartDisabled: "Đăng nhập để đặt món",
    },
    categoryPage: {
    ...
    auth: {
      ...
      loginSubtitle: "Nhập email và mật khẩu để tiếp tục đặt món.",
      registerTitle: "Đăng ký tài khoản",
      registerSubtitle:
        "Tạo tài khoản FCO để lưu địa chỉ và theo dõi đơn hàng dễ dàng.",
      nameLabel: "Họ và tên",
      emailLabel: "Email",
      ...
      errors: {
        ...
        emailTaken: "Email này đã được đăng ký. Vui lòng đăng nhập.",
  ...
  en: {
    ...
    menuLabels: {
      ...
      addToCartDisabled: "Sign in to order",
    },
    categoryPage: {
      breadcrumbHome: "Home",
    ...
    auth: {
      ...
      registerSubtitle:
        "Create an FCO account to save addresses and track orders easily.",
      nameLabel: "Full name",
      emailLabel: "Email",
